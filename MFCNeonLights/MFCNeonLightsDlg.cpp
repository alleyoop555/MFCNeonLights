...
// MFCNeonLightsDlg.cpp : implementation file
//
...
// CMFCNeonLightsDlg message handlers

BOOL CMFCNeonLightsDlg::OnInitDialog()
{
...
void CMFCNeonLightsDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMFCNeonLightsDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CMFCNeonLightsDlg::OnQueryDragIcon()
{
